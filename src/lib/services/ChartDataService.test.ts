...
describe("ChartDataService", () => {
  ...
  describe("formatProgressData", () => {
    ...
    it("should throw error for invalid input", () => {
      ...
      expect(() => ChartDataService.formatProgressData(null as any)).toThrow(
        "Invalid input: expected array of ProgressDataPoint",
      );
    });
  });
  ...
  describe("formatActivityData", () => {
    ...
    it("should throw error for invalid input", () => {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      expect(() =>
        ChartDataService.formatActivityData("invalid" as any),
      ).toThrow("Invalid input: expected array of ActivityDataPoint");
    });
  });
});